...
def Feed_Foward_Neural_Network_MultiLayers(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 5000):
    ...
    Y -- true "label" vector (containing 1 if belongs to corresponding digit class, otherwise 0), of shape (10, number of examples)
...
def main():
    ...
    #layers_dims = [784, 15, 7, 10] 
    
    layers_dims = [784, 40,  20, 17, 12, 10] 
